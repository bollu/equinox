...
impl Mat3 {
	...
	pub fn invert(&self) -> Mat3 {
		...
		inv_elem.push_all( [i00 / det, i10 / det, i20 / det, i01 / det, i11 / det, i21 / det, i02 / det, i12 / det, i22 / det ]);
...
impl Show for Mat3 {
	fn fmt(&self, formatter: &mut Formatter) -> Result {
		...
		write!(formatter.buf, "\n|{:.2}, {:.2}, {:.2}|\n|{:.2}, {:.2}, {:.2}|\n|{:.2}, {:.2}, {:.2}|\n", 
			elem.get(0), elem.get(1), elem.get(2),
			elem.get(3), elem.get(4), elem.get(5),
			elem.get(6), elem.get(7), elem.get(8))
	}
}